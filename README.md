...
这个项目是冲着 **AI-native 游戏开发 / Vibe Coding** 岗位做的，刻意覆盖了 JD 的几个核心诉求：

| 岗位诉求 | 这个 demo 怎么体现 |
| --- | --- |
| **AI Game / AI + 产品创新** | AI 不是工具，而是玩法本身——嫌疑人是活的 LLM 角色，「审问 AI」就是核心循环 |
| **把玩法需求拆解成 AI 可理解的描述** | 每个嫌疑人都是一份精心设计的 system prompt（人设 / 知情边界 / 说谎方式 / 护栏），见 [PROMPT-DESIGN](docs/PROMPT-DESIGN.md) |
| **快速做出可玩的 H5 / Demo 原型** | 纯前端 H5，开箱即玩，一条链接即可分享、可部署到 GitHub Pages |
| **AI 工作流探索** | 记录了真实的「玩法 → AI 描述 → 验证」开发流程，见 [AI-WORKFLOW](docs/AI-WORKFLOW.md) |
| **对玩法有自己的理解** | 做了一个关键产品取舍：**对话交给 LLM，胜负判定交给作者数据**（下文） |
